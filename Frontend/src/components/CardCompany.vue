<template>
  <div class="flex flex-wrap justify-center gap-10 mt-10 px-5 md:px-12">
    ...
    <div class="w-[240px] md:w-[300px] sm:max-w-[330px] bg-white/10 backdrop-blur-sm p-6 rounded-2xl text-center transition-transform duration-300 hover:-translate-y-1">
      ...
      <h2 class="text-xl md:text-2xl font-semibold text-white mb-2 drop-shadow">Google Cloud</h2>
    ...
    <div class="w-[240px] md:w-[300px] sm:max-w-[330px] bg-white/10 backdrop-blur-sm p-6 rounded-2xl text-center transition-transform duration-300 hover:-translate-y-1">
      ...
      <h2 class="text-xl md:text-2xl font-semibold text-white mb-2 drop-shadow">Cisco Academy</h2>
    ...
    <div class="w-[240px] md:w-[300px] sm:max-w-[330px] bg-white/10 backdrop-blur-sm p-6 rounded-2xl text-center transition-transform duration-300 hover:-translate-y-1">
      ...
      <h2 class="text-xl md:text-2xl font-semibold text-white mb-2 drop-shadow">Dicoding Indonesia</h2>
